...
Either auto play or if time allows pick up a reord and drop it into the beam of light.
once there it will start playing.
it can then be grabbed out to stop it and another inserted.

# How it works
curently working on hopes and dreams.
Base and record will be simple primatives. will see about making proves in the records.
Light will be made with unity light effects
rotations and color will be andles by C# code
starting and stopping records will be done by moving them with oculus controlls.
